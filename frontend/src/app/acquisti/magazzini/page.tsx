...
import MagazzinoWorkspace from "@/components/purchasing/MagazzinoWorkspace";
      ...
      <div className="flex">
        ...
        <main className="flex-1 min-w-0">
          <div className="max-w-[1600px] mx-auto px-4 md:px-6 py-5 space-y-5">
            ...
            <p className="text-sm text-slate-500 -mt-2">Giacenze, ingressi, uscite e collegamenti contabili in un unico workspace</p>
            <MagazzinoWorkspace />
          </div>
        </main>
      </div>
