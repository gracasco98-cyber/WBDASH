          ...
          <article key={product.name} className="overflow-hidden rounded-[11px] border border-[#dfe6ee] bg-white">
            ...
            <dl className="grid grid-cols-2 border-t border-[#edf1f5]">
              {[
                ...
                ["Ads", product.ads], ["ACOS reale", product.acos],
